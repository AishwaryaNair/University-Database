-- Table: PersonStatus
INSERT INTO pr2.PersonStatus (PersonStatus)
	VALUES  ('Active'),
			('Inactive');
GO

-- Table: Addresses
INSERT INTO pr2.Addresses (AddressLine1, AddressLine2, City, State, Country, PostalCode) 
...
-- Table: Person
INSERT INTO pr2.Person (PersonId, FirstName, LastName, NetID, Password, DateOfBirth, SocialSecurityNo, LocalAddress, HomeAddress, PersonStatus)
...
-- Table: Students
INSERT INTO pr2.Students (StudentId, PersonId, StudentStatusId)
...
INSERT INTO pr2.ProgramOfStudy (ProgOfStudyId, ProgOfStudy, CollegeId)
...
-- Table: Majors
INSERT INTO pr2.Majors (StudentId, ProgOfStudyId)
	VALUES  ('STU01-AD', 'ELE'),
			('STU02-DB', 'CSE'),
			('STU03-JZ', 'IST'),
			('STU04-CZ', 'TNM'),
...
-- Table: Minors
INSERT INTO pr2.Minors (StudentId, ProgOfStudyId)
	VALUES  ('STU03-JZ', 'BDJ'),
			('STU03-JZ', 'PHO'),
			('STU04-CZ', 'ANT'),
			('STU05-TZ', 'EEE');
...
INSERT INTO pr2.BenefitsSelection (Benefits)
	VALUES  ('Single'),
			('Family'),
			('Op-out');
GO
...
INSERT INTO pr2.VisionBenefits (VisionBenefitsId, Cost, BenefitsSelection)
	VALUES  ('VB01', 900, 1),
			('VB02', 1300, 2),
			('VB03', 500, 1),
			('VB04', 2500, 2),
...
INSERT INTO pr2.DentalBenefits (DentalBenefitsId, Cost, BenefitsSelection)
	VALUES  ('DB01', 800, 1),
			('DB02', 1500, 2),
			('DB03', 500, 1),
			('DB04', 1200, 2),
...
INSERT INTO pr2.JobInformation (JobInformationId, JobTitle, JobDescription, JobRequirements, MinPay, MaxPay, UnionJob)
...
-- Table: Employees
INSERT INTO pr2.Employees (EmployeeId, PersonId, YearlyPay, JobInformation, HealthBenefits,	VisionBenefits, DentalBenefits)
...
-- Table: Courses
INSERT INTO pr2.Courses (CourseId, CourseCode, CourseNumber, CourseTitle, CourseDescription)
	VALUES  ('ARC638', 'ARC', '638', 'American Architecture, 1860 - World War I', 'American architectural history and theory from the Civil War 
			...
			('ANT624', 'ANT', '624', 'Negotiation: Theory and Practice', 'Negotiation skills for resolving differences effectively and achieving 
			 mutually satisfying outcomes. Position based versus interest based negotiation. Advanced techniques of communication such as chunking, 
			 reframing, anchoring, metaphor and rapport to obtain negotiation outcomes of excellence. Additional work required of graduate students.');
GO

-- Table: Prerequisites
INSERT INTO pr2.Prerequisites (PrereqId, ParentCourseId, ChildCourseId)
...
-- Table: Semester
INSERT INTO pr2.Semester (Semester)
	VALUES  ('Fall'),
			('Spring'),
			('Summer I'),
			('Summer II'),
...
-- Table: SemesterInfo
INSERT INTO pr2.SemesterInfo (Semester, SemYear, StartDate, EndDate)
...
-- Table: BuildingName
INSERT INTO pr2.BuildingName (BuildingId, Name)
...
-- Table: Location
INSERT INTO pr2.Location (LocationId, BuildingName, RoomNumber)
...
-- Table: Classroom
INSERT INTO pr2.Classroom (Location, MaxSeating, Projector, NoOfWhiteBoards, AVEquipment) 
...
INSERT INTO pr2.ScheduledCourses (CourseId, FacultyId, Semester, NoOfSeats, Classroom)
...
INSERT INTO pr2.DailyCourseDay (ScheduledId, DayOfTheWeek, StartTime, EndTime)
...
INSERT INTO pr2.EnrollmentStatus (EnrollmentStatus)
	VALUES  ('Regular'),
			('Pass/Fail'),
			('Audit');
GO
...
-- Table: StudentGrade
INSERT INTO pr2.StudentGrade (Grade, GradePoints)
	VALUES  ('A', 4.0),
			('A-', 3.66),
			('B+', 3.33),
			('B', 3.0),
...
-- Table: Enrollment
INSERT INTO pr2.Enrollment (StudentId, ScheduleId, EnrollmentStatus, StudentGrade)
